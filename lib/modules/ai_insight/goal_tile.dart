    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          boxShadow: [
            BoxShadow(spreadRadius: 2,color: const Color.fromARGB(78, 201, 200, 200),offset: Offset(2, 2),blurRadius: 2)
          ],
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: U.Text(
                      ...
                      // softWrap: true,
                      text: goal.roadmap!.goal,textSize: U.TextSize.s14,textWeight: U.TextWeight.semiBold,),
                  ),
                ),
                // Spacer(),
                   U.Text(text: 'Ai insights!',textSize: U.TextSize.s12,textWeight: U.TextWeight.sm,color: U.Theme.quaternaryText,), SizedBox(width: 4),
